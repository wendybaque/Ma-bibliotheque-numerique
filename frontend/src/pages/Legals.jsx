...
const Legals = () => {
  return (
    <div
      ...
      className="flex flex-col text-center font-poppins m-6 "
    >
      <h2 className="text-2xl m-2 text-yellow-600">Mentions Légales - RGPD</h2>
      <p className="font-bold m-2 text-yellow-600">En vigueur le 16/02/2023</p>
      <h3 className="font-bold m-2 text-lg">Définitions</h3>
      <p className="text-left leading-relaxed mb-2">
        ...
        le Site objet des présentes conditions générales. Prestations et
        Services : https://mabibliothequenumerique.com met à disposition des
        Clients :
        <br />
        ...
        détenues par https://mabibliothequenumerique.com pour la gestion de
      ...
      <h3 className="font-bold m-2 text-lg">
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        site internet https://mabibliothequenumerique.com l'identité des
        différents intervenants dans le cadre de sa réalisation et de son suivi:
        <br />
        Propriétaire : SAS Ma Bibliothèque Numérique Capital social de 10000€
        Numéro de TVA: 12345678910 – 20 Avenue Rapp 37005 Paris Responsable
        publication : Wendy Baqué – baque.wendy@gmail.com Le responsable
        publication est une personne physique ou une personne morale. Webmaster
        : Wendy Baqué – baque.wendy@gmail.com Hébergeur : Hostinger – 61 Lordou
        Vironos st. 6023 Larnaca 08 92 97 70 93 Délégué à la protection des
        données : Baqué Wendy – baque.wendy@gmail.com Ces mentions légales RGPD
        sont issues du générateur de mentions légales RGPD d'Orson.io
      </p>
      <h3 className="font-bold m-2 text-lg">
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        <br />
        L’utilisation du site https://mabibliothequenumerique.com implique
        ...
        https://mabibliothequenumerique.com sont donc invités à les consulter de
        manière régulière.
        <br />
        ...
        être toutefois décidée par https://mabibliothequenumerique.com, qui
        s’efforcera alors de communiquer préalablement aux utilisateurs les
        dates et heures de l’intervention. Le site web
        https://mabibliothequenumerique.com est mis à jour régulièrement par
        https://mabibliothequenumerique.com responsable. De la même façon, les
      ...
      <p className="text-left leading-relaxed mb-2">
        Le site internet https://mabibliothequenumerique.com a pour objet de
        fournir une information concernant l’ensemble des activités de la
        société. https://mabibliothequenumerique.com s’efforce de fournir sur le
        site https://mabibliothequenumerique.com des informations aussi précises
        ...
        https://mabibliothequenumerique.com sont données à titre indicatif, et
        sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant
        sur le site https://mabibliothequenumerique.com ne sont pas exhaustifs.
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        https://mabibliothequenumerique.com est hébergé chez un prestataire sur
        ...
        réputé anormal.
        <br />
        https://mabibliothequenumerique.com et l’hébergeur ne pourront être
      ...
      <p className="text-left leading-relaxed mb-2">
        https://mabibliothequenumerique.com est propriétaire des droits de
        ...
        https://mabibliothequenumerique.com.
        <br />
      ...
      <p className="text-left leading-relaxed mb-2">
        https://mabibliothequenumerique.com agit en tant qu’éditeur du site.
        https://mabibliothequenumerique.com est responsable de la qualité et de
        la véracité du Contenu qu’il publie.
        <br />
        https://mabibliothequenumerique.com ne pourra être tenu responsable des
        dommages directs et indirects causés au matériel de l’utilisateur, lors
        de l’accès au site internet https://mabibliothequenumerique.com, et
        ...
        <br />
        https://mabibliothequenumerique.com ne pourra également être tenu
        ...
        https://mabibliothequenumerique.com. Des espaces interactifs
        (possibilité de poser des questions dans l’espace contact) sont à la
        disposition des utilisateurs. https://mabibliothequenumerique.com se
        ...
        https://mabibliothequenumerique.com se réserve également la possibilité
      ...
      <h4 className="font-bold m-2 text-medium italic">
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        responsable du traitement des Données Personnelles est : Ma Bibliothèque
        Numérique. https://mabibliothequenumerique.comest représenté par Baqué,
        son représentant légal
        <br />
        En tant que responsable du traitement des données qu’il collecte,
        https://mabibliothequenumerique.com s’engage à respecter le cadre des
        ...
        Chaque fois que https://mabibliothequenumerique.com traite des Données
        Personnelles, https://mabibliothequenumerique.com prend toutes les
        ...
        https://mabibliothequenumerique.com les traite.
      </p>
      <h4 className="font-bold m-2 text-medium italic">
        7.2 Finalité des données collectées
      </h4>
      <p className="text-left leading-relaxed mb-2">
        https://mabibliothequenumerique.com est susceptible de traiter tout ou
        partie des données :
        ...
        des commandes, etc.
        <br /> - pour prévenir et lutter contre la fraude informatique
        (spamming, hacking…) : matériel informatique utilisé pour la navigation,
        l’adresse IP, le mot de passe (hashé)
        <br /> - pour améliorer la navigation sur le Site : données de connexion
        et d’utilisation
        <br /> - pour mener des enquêtes de satisfaction facultatives sur
        https://mabibliothequenumerique.com : adresse email
        <br /> - pour mener des campagnes de communication (sms, mail) : numéro
        de téléphone, adresse email https://mabibliothequenumerique.com ne
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        de https://mabibliothequenumerique.com disposent des droits suivants :
        <br /> - droit d'accès (article 15 RGPD) et de rectification (article 16
        RGPD), de mise à jour, de complétude des données des Utilisateurs droit
        de verrouillage ou d’effacement des données des Utilisateurs à caractère
        ...
        RGPD)
        <br /> - droit à la limitation du traitement des données des
        ...
        mort et de choisir à qui https://mabibliothequenumerique.com devra
        communiquer (ou non) ses données à un tiers qu’ils aura préalablement
        désigné Dès que https://mabibliothequenumerique.com a connaissance du
        décès d’un Utilisateur et à défaut d’instructions de sa part,
        https://mabibliothequenumerique.com s’engage à détruire ses données,
        ...
        https://mabibliothequenumerique.com utilise ses Données Personnelles,
        demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur
        peut contacter https://mabibliothequenumerique.com par écrit à l’adresse
        suivante :
        <br />
        Ma Bibliothèque Numérique – DPO, Baqué Wendy 20 Avenue Rapp 37005 Paris.
        <br />
        Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
        souhaiterait que https://mabibliothequenumerique.com corrige, mette à
        ...
        obligations qui sont imposées à https://mabibliothequenumerique.com par
        la loi, notamment en matière de conservation ou d’archivage des
        documents. Enfin, les Utilisateurs de
        https://mabibliothequenumerique.com peuvent déposer une réclamation
      ...
      <p className="text-left leading-relaxed mb-2">
        https://mabibliothequenumerique.com s’interdit de traiter, héberger ou
        ...
        Pour autant, https://mabibliothequenumerique.com reste libre du choix de
        ...
        Règlement Général sur la Protection des Données (RGPD : n° 2016-679).
        <br />
        https://mabibliothequenumerique.com s’engage à prendre toutes les
        ...
        de https://mabibliothequenumerique.com, celle-ci devra dans les
        meilleurs délais informer le Client et lui communiquer les mesures de
        corrections prises. Par ailleurs https://mabibliothequenumerique.com ne
        collecte aucune « données sensibles ».
        <br />
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de https://mabibliothequenumerique.com et des sous-traitants
        ...
        https://mabibliothequenumerique.com sont principalement les agents de
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        https://mabibliothequenumerique.com n'est publiée à l'insu de
        l'utilisateur, échangée, transférée, cédée ou vendue sur un support
        quelconque à des tiers. Seule l'hypothèse du rachat de
        https://mabibliothequenumerique.com et de ses droits permettrait la
        ...
        https://mabibliothequenumerique.com utilise des réseaux protégés par des
        ...
        https://mabibliothequenumerique.comprend toutes les mesures raisonnables
        visant à les protéger contre toute perte, utilisation détournée, accès
        non autorisé, divulgation, altération ou destruction.
      </p>
      <h3 className="font-bold m-2 text-lg">
        Article 9. Liens hypertextes « cookies » et balises (“tags”) internet
      </h3>
      <p className="text-left leading-relaxed mb-2">
        Le site https://mabibliothequenumerique.com contient un certain nombre
        de liens hypertextes vers d’autres sites, mis en place avec
        l’autorisation de https://mabibliothequenumerique.com. Cependant,
        https://mabibliothequenumerique.com n’a pas la possibilité de vérifier
        le contenu des sites ainsi visités, et n’assumera en conséquence aucune
      ...
      <h4 className="font-bold m-2 text-medium italic">9.1. « COOKIES »</h4>
      <p className="text-left leading-relaxed mb-2">
        ...
        de l’Utilisateur.
        <br />
        https://mabibliothequenumerique.com est susceptible de traiter les
        ...
        permettent à https://mabibliothequenumerique.com d’améliorer le contenu
        ...
        d’être enregistré dans son terminal. https://mabibliothequenumerique.com
        ...
        être le cas lorsque https://mabibliothequenumerique.com ou l’un de ses
        ...
        connecté à Internet.
        <br />
        Le cas échéant, https://mabibliothequenumerique.com décline toute
        responsabilité pour les conséquences liées au fonctionnement dégradé du
        Site et des services éventuellement proposés par
        https://mabibliothequenumerique.com, résultant (i) du refus de Cookies
        par l’Utilisateur (ii) de l’impossibilité pour
        https://mabibliothequenumerique.com d’enregistrer ou de consulter les
        ...
        https://mabibliothequenumerique.com pourra en outre faire appel aux
        ...
        https://mabibliothequenumerique.com ou dans son application mobile et si
        l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation
        sur le Site Internet ou l’application mobile de
        https://mabibliothequenumerique.com, Twitter, Facebook, Linkedin et
        ...
        Internet ou l’application mobile de https://mabibliothequenumerique.com.
        À tout moment, l’Utilisateur peut néanmoins revenir sur son consentement
        à ce que https://mabibliothequenumerique.com dépose ce type de cookies.
      </p>
      <h4 className="font-bold m-2 text-medium italic">
        Article 9.2. BALISES (“TAGS”) INTERNET
      </h4>
      <p className="text-left leading-relaxed mb-2">
        https://mabibliothequenumerique.com peut employer occasionnellement des
        ...
        pages de celui-ci.
        <br />
        Cette technologie permet à https://mabibliothequenumerique.com d’évaluer
        ...
        https://mabibliothequenumerique.com, et fournir d’autres services
      ...
      <p className="text-left leading-relaxed mb-2">
        ...
        https://mabibliothequenumerique.com est soumis au droit français. En
