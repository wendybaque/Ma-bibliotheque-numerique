...
const Library = () => {
  ...
  return (
    <div className="bg-slate-100">
      ...
      <h1 className="text-xl text-center font-bold m-2 p-2">Tous mes livres</h1>
      </header>

      <Link to="/add"><button className="hover:animate-bounce cursor-pointer text-white hover:text-white bg-yellow-600 box-shadow-lg font-bold rounded-lg text-sm px-5 py-2.5 text-center mr-8 ml-8 mt-6">Ajouter un nouveau livre</button></Link>
