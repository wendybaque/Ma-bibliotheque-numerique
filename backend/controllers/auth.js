...
db.query(query, [req.body.email, req.body.username, req.body.img ], (err, data) => {
...
export const signin = (req, res) => {
    ...
    db.query(query, [req.body.username], (err, data) => {
        ...
        // CHECK PASSWORD
        const isPasswordCorrect = bcrypt.compareSync(req.body.password, data[0].password, req.body.img);
        if(!isPasswordCorrect) return res.status(400).json("Erreur dans le nom de l'utilisateur ou du mot de passe.");
